...
namespace AsteroidGame
{
    static class Game
    {
        ...
        public static void Initialize(Form myGameForm)
        {
            ...
            if (myGameForm.Height > 1000 | myGameForm.Width > 1000 | myGameForm.Height < 0 | myGameForm.Width < 0) { throw new SplashScreenException("Upps! Sorry, this is not allowed!", DateTime.Now); } //Если ставлю значение больше 1000, то всё хорошо, но если, например, ставлю Width = -1, по факту Width = 136, почему так? Спасибо большое, что проверяете код!
